...
var Fleet = []FleetMachine{
	{
		...
		VMs: []FleetVM{
			...
			{ID: "main_machine_vm6", Name: "VM6"},
			{ID: "main_machine_vm7", Name: "VM7"},
			{ID: "main_machine_vm8", Name: "VM8"},
			{ID: "main_machine_vm9", Name: "VM9"},
			{ID: "main_machine_vm10", Name: "VM10"},
			{ID: "main_machine_vm11", Name: "VM11"},
			{ID: "main_machine_vm12", Name: "VM12"},
			{ID: "main_machine_vm13", Name: "VM13"},
			{ID: "main_machine_vm14", Name: "VM14"},
			...
			{ID: "main_machine_vm20", Name: "VM20"},
		},
	},
	{
		ID:       "mini_pc_ui",
